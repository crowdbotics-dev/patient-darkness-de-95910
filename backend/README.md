...
## Project Structure
    ...
    ├── patient_darkness_de_95910  # Django project configurations
...
1. Clone this repo and `cd patient_darkness_de_95910`
...
2. Clone this repo and `cd patient_darkness_de_95910`
